...
OPENAI_API_KEY = get_clean_var("OPENAI_API_KEY", "")  # For AI Chat
...
async def ai_chat_handler(client, msg):
    if not OPENAI_API_KEY:
        return await msg.reply("⚠️ OpenAI API Key set nahi hai!")
    ...
    try:
        response = await asyncio.to_thread(
            ...
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are a helpful coding, bot development, Telegram, Python, and general knowledge assistant."},
